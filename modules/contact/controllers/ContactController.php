...
Class ContactController extends Controller
{
    ...
    public function IndexAction()
    {
        ...
        $View->setTitle("Dean Training - Contact US");
        ...
        $View->Render(array('navbar' => $NavBar->render(array('active' => 'contactus')),
            'titlebar' => $TitleBar->render(array('title' => 'Contact Us')),
        ...
        if ($_POST) {
            ...
            if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['number']) && isset($_POST['message'])
                ...
                if($responseKeys["success"]) {
                    ...
                    $from = "{$_POST['email']}";
                    $subject = "Contact Request on Dean Training";
                    ...
                    $this->setFlag('Contact Request Sent!');
