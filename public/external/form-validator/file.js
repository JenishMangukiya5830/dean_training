(function ($, window) {
    "use strict";
    var SUPPORTS_FILE_READER = typeof window.FileReader != "undefined", _getTypes = function ($input) {
    ...
    $.formUtils.addValidator({name: "mime", validatorFunction: function (str, $input, conf, language) {
    ...
    $.formUtils.addValidator({name: "extension", validatorFunction: function (value, $input, conf, language) {
    ...
    $.formUtils.addValidator({name: "size", validatorFunction: function (val, $input, conf, language) {
